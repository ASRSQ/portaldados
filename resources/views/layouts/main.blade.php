...
<body>
  <div class="container mx-0">
    <div class="row">
      <div class="col-sm-3 bg-primary vh-sm-100" >
        <div class="offcanvas offcanvas-start d-none d-sm-block bg-primary vh-100" id="sidebarMenu" tabindex="-1">
  ...
  <script>
      ...
      const sidebarMenu = new bootstrap.Offcanvas(document.querySelector('#sidebarMenu'));
